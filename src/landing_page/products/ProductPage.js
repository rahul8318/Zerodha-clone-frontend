...
function ProductPage() {
  return (
   ...
   <LeftImg
     ...
     appStore="/product1/app-store"
   />
   <p className='text-center fs-4 mt-4'>Want to know more about our technology stack? Check out the <a href="https://zerodha.tech" style={{ color: "#387ed1", textDecoration: "none" }}>Zerodha.tech </a>blog.</p>
   <Univers/>
   </>
  )
}
