...
function Hero() {
  return (
    <div className="container">
      ...
      <div className="row p-5 mb-5 border-top text-muted " style={{fontSize:"1.2em", lineHeight:"1.8"}}>
       ...
       <div className="col-6 p-5">
        ...
        <p>
        <a style={{color:"#007bff", textDecoration:"none"}} href="#">Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.
        </p>
